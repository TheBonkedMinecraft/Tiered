...
public class ReforgeScreenHandler extends ScreenHandler {
    ...
    private void updateResult() {
        if (this.getSlot(0).hasStack() && this.getSlot(1).hasStack() && this.getSlot(2).hasStack()) {
            ...
            if (ModifierUtils.getRandomAttributeIDFor(null, item.getDefaultStack(), false) != null && !this.getSlot(1).getStack().isDamaged()) {
    ...
    public ItemStack transferSlot(PlayerEntity player, int index) {
        ...
        if (slot != null && slot.hasStack()) {
            ...
            if (index == 1) {
                ...
                if (ModifierUtils.getRandomAttributeIDFor(null, itemStack, false) != null && !this.insertItem(itemStack2, 1, 2, false))
                    return ItemStack.EMPTY;
            }
